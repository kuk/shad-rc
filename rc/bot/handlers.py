...
COMMAND_DESCRIPTIONS = {
    ...
    MATCH_WORLD_COMMAND: 'хочу собеседника из любого города',
...
- В анкете есть поле "город", нажми /{MATCH_CITY_COMMAND}, чтобы бот подбирал собеседников из твоего города.
...
Автор проекта Наташа https://github.com/natasha - библиотеки для русскоязычного NLP. Работаю в своей Лабе https://lab.alexkuk.ru, адаптирую Наташу под задачи клиентов. Присматриваю за чатиком @natural_language_processing - самое крупное сообщество про NLP на русском.

Живу в Москве в Крылатском. У нас тут мекка велоспорта. Умею сидеть на колесе и сдавать смену. Бегаю, пробежал 10 км за 39 минут. Занимаюсь древнерусской каллиграфией. Вожу экскурсии для друзей, рассказываю про сталинский генплан, импрессионистов и супрематистов."
...
Заполни, пожалуйста, ссылки /{EDIT_LINKS_COMMAND} или "о себе" /{EDIT_ABOUT_COMMAND}. Собеседник поймёт чем ты занимаешься, о чём интересно спросить. Снимает неловкость в начале разговора.'''
    ...
    if not user.city:
        yield f'''
Чтобы бот подбирал собеседников из твоего города, заполни поле "город" в анкете /{EDIT_CITY_COMMAND} и нажми /{MATCH_CITY_COMMAND}'''
